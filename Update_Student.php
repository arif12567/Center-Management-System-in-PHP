...
$query="SELECT * FROM `add_student` WHERE `student_id`='$student_id'";
                                ...
                                <div class="card ">
                                    ...
                                    <form action="#" method='post'>
                                        <div class="form-group">
                                            <input type="text" name="name" id="name" class="form-control"  placeholder="Name" autocomplete="off" value="<?php echo $row['name'] ?>">
                                        </div>

                                        <div class='form-group'>
                                        <input type="text" name="F_name" id="F_name" class="form-control" placeholder="Father's Name" autocomplete="off" value="<?php echo $row['fname'] ?>">
                                        </div>

                                        <div class='form-group'>
                                        <input type="text" name="caste" id="caste" class="form-control" placeholder="Caste" autocomplete="off" value="<?php echo $row['caste'] ?>">
                                        </div>

                                        <div class='form-group'>
                                        <input type="text" name="address" id="address" class="form-control" placeholder="Address" autocomplete="off" value="<?php echo $row['address'] ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="submit" name="edt_button" id="edt_button" class="form-control btn-primary" value="Update Student">
                                        </div>
                                        </form><!--End Form-->
                            ...
                            <script src="js/jquery-3.5.1.min.js"></script> 
                                                ...
                                                <?php // Student edt data start
                                                        ...
                                                        if(isset($_POST['edt_button'])){
                                                            ...
                                                            $query = "UPDATE `add_student` SET `name`='$name',`fname`='$fname',`caste`='$caste',`address`='$address' WHERE `student_id`='$student_id'";
                                                            $data=mysqli_query($conn,$query);
